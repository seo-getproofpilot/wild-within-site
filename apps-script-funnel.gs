...
function sendGuideEmail_(lead) {
  ...
  var html = ''
    ...
    + 'better fit to start with.</p>'
    + '<p>If you picked a time for your consult, it is confirmed and the '
    + 'details are in a separate email. If you did not, '
    + escapeHtml_(matched) + ' will reach out within one business day to '
    + 'find one that works.</p>'
